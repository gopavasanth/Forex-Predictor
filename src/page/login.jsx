...
class Login extends Component {
                  ...
                  <div className="row">
                    <div className="col-xs-12">
                      <header id="login-header">
                        <div id="login-logo">
                          <p>Welcome to the SAP Forex forecaster 📈</p>
                          {/* { loginPage.logo_img ? <img alt="Logo" src={loginPage.logo_img}  /> : <img alt="" /> } */}
                        </div>
                      </header>
                      <div id="login-box-inner">
                        ...
                        <div className="row">
                          <div className="col-xs-12 social-text">
                            <MessageAlert
                              hide={this.alertHide.bind(this)}
                              option={this.state.alert}
                            />
                        ...
                        <div className="row">
                          <div className="col-xs-12 col-sm-6">
                            <a
                              ...
                              target="_blank"
                              href="https://github.com/fearlessforever"
                            >
  ...
  componentDidMount() {
    ...
    if (loginPage.background_img) {
      document.body.style.background =
        "url(" + loginPage.background_img + ") fixed no-repeat center";
    }
  }
  ...
  handleClickAlert() {
    let { alertObject } = this.state,
      temp = { alertObject, className: "hidden" };
    this.setState({
      alertObject: temp,
    });
  }
