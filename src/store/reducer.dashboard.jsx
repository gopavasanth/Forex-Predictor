...
const dashBoard = (state={
	user:{photo:'/external/img/Vasanth.jpg',name:'Vasanth'},
	...
	messageList:[
		{name:'George Clooney',pic:'/external/img/samples/ryan.png',teks:"Look, It's right time to hedge as the prices might got high soon...",waktu:'13 min.'}
		,{name:'Emma Watson',pic:'/external/img/samples/emma.png',teks:"Look, Don't make it right for Marsellus to throw...",waktu:'13 min.'}
